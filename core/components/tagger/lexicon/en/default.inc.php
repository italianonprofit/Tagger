...
$_lang['tagger.group.filter_type'] = 'Filter type';
$_lang['tagger.group.filter_type_desc'] = 'Tipo di filtro da interpretare in frontend';
...
$_lang['tagger.group.searchable'] = 'Campo ricercabile?';
$_lang['tagger.group.searchable_desc'] = 'If set to <strong>yes</strong>, users will be able to search from field.';
...
$_lang['tagger.tag.assigned_childs'] = 'Tag Figli assegnati';
$_lang['tagger.tag.assigned_resources'] = 'Assigned resources';
$_lang['tagger.tag.assigned_resources_to'] = 'Assigned resources to [[+tag]]';
$_lang['tagger.tag.assigned_childs_to'] = 'Tag figli di [[+tag]]';
$_lang['tagger.tag.resource_update'] = 'Update resource';
$_lang['tagger.tag.resource_unassign'] = 'Unassign resource';
$_lang['tagger.tag.child_unassign'] = 'Rimuovi associazione';
$_lang['tagger.tag.child_unassign_confirm'] = 'Are you sure, you want to unassign this child?';
...
$_lang['tagger.tag.child_unassign_multiple_confirm'] = 'Are you sure, you want to unassign selected ([[+resources]]) tag?';
$_lang['tagger.tag.resource_unasign_selected'] = 'Unassign selected';
$_lang['tagger.tag.child_unasign_selected'] = 'Unassign selected';
